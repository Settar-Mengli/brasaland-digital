...
GitHub Actions runs pytest across nine service and package directories, the `data/` pipelines suite, Vitest across three npm workspaces, and TypeScript typecheck across four workspaces (see `.github/workflows/ci.yml`).
