...
GitHub Actions runs pytest across nine service and package directories, the `data/` pipelines suite, and Vitest across three npm workspaces (see `.github/workflows/ci.yml`).
